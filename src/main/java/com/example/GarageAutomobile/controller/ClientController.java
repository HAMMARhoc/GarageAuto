...
import com.example.GarageAutomobile.controller.form.ClientForm;
...
public class ClientController {
	...
	/**
	 * Après être passé par afficherCreerClient, je crée le client à partir du
	 * formulaire récupéré
	...
	/**
	 * Permet de récupérer ce qui a été envoyé par afficherModifierClient, converti le
